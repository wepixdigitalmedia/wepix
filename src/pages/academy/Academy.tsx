...
const offerings = [
  ...
  { icon: Video, title: "Live Masterclasses", description: "Direct 3-hour live sessions with Abdul Navas. Upcoming: Build Your First AI Employee (10th Oct 2026, ₹1,999).", href: "/academy/webinar", img: "Webinar screenshot" },
